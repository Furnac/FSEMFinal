...
public class Controller {
  ...
  @FXML void ca1d_initialize(ActionEvent event) {}
  @FXML void ca1d_clear(ActionEvent event) {}
  @FXML void ca1d_setSpeed(ActionEvent event) {}
  @FXML void ca1d_setWidth(ActionEvent event) {}
  @FXML void ca1d_setHeight(ActionEvent event) {}
  @FXML void ca1d_setRulesRad(ActionEvent event) {}
  @FXML void ca1d_setRulesText(ActionEvent event) {}
  //</editor-fold>
  
  //TWO DIMENSIONAL
  //<editor-fold desc="all ca2d stuff">
  @FXML private Slider ca2d_speedSlider;
  @FXML private Slider ca2d_widthSlider;
  @FXML private Slider ca2d_heightSlider;
  ...
  @FXML void ca2d__initialize(ActionEvent event) {}
  @FXML void ca2d_clear(ActionEvent event) {}
  @FXML void ca2d_setSpeed(ActionEvent event) {}
  @FXML void ca2d_setWidth(ActionEvent event) {}
  @FXML void ca2d_setHeight(ActionEvent event) {}
